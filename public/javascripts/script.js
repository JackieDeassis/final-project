...
// ===========================
// LOAD WISHES (WITH ERROR HANDLING)
// ===========================
async function loadWishes() {
  try {
    ...
    console.error(error);
    container.innerHTML = '<p style="text-align:center;">⚠️ Could not load wishes. Try again later.</p>';
  }
}
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    console.error(error);
    alert('⚠️ Something went wrong while submitting your wish.');
  }
});
